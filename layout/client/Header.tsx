...
export default function Header() {
  ...
  React.useEffect(() => setGeolocation(geolocation), [geolocation])
    ...
    <Container p={6}>
      <Flex w="100%" align="center">
        ...
        <HStack spacing={6}>
          ...
          <Button hidden={isMobile || isAuthed} leftIcon={<FaSignInAlt />} textColor="gray.900" colorScheme="primary" onClick={login.onToggle}>
            {t('sign-in')}
          </Button>
