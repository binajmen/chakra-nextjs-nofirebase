    ...
    <Box>
      ...
      <Formik
        ...
        onSubmit={(values, actions) => {
          console.log(values)
          const { available, name, description, code, price, tax, tags, events, modifiers, categoryIds, modifierIds, type } = values

          save({ available, name, description, code, price, tax, tags, events, modifiers, categoryIds, modifierIds, type })!
            .then(() => toast({
