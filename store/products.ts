...
// type ReadCategoryPayload = { placeId: string, categoryId: string }
// type CreatePayload = { placeId: string, categoryId?: string, product: Product }
// type UpdatePayload = { placeId: string, productId: string, product: Product }
// type DeletePayload = { placeId: string, productId: string }
// type AvailabilityPayload = { placeId: string, productId: string, available: boolean }
...
//   getProductsInCategory: thunk(async (actions, { placeId, categoryId }, helpers) => {
//     try {
//       const { getStoreState, getStoreActions } = helpers

//       if (!(categoryId in getStoreState().categories.list)) {
//         getStoreActions().categories.getCategory({ placeId, categoryId })
//       }
...
//   createProduct: thunk(async (actions, { placeId, categoryId = "", product }, helpers) => {
//     const { getStoreActions } = helpers
//     try {
...
//   updateProduct: thunk(async (actions, { placeId, productId, product }, helpers) => {
//     const { getStoreActions } = helpers
//     try {
//       // update in firestore
//       await firebase.firestore()
...
//   deleteProduct: thunk(async (actions, { placeId, productId }, helpers) => {
//     const { getStoreActions } = helpers
//     try {
//       const { getState } = helpers
...
//   updateAvailability: thunk(async (actions, { placeId, productId, available }, helpers) => {
//     const { getStoreActions } = helpers
//     try {
//       await firebase.firestore()
//         .collection('places').doc(placeId)
