...
// type ReadPayload = { placeId: string, categoryId: string }
// type CreatePayload = { placeId: string, category: Category }
// type UpdatePayload = { placeId: string, categoryId: string, category: Category }
// type DeletePayload = { placeId: string, categoryId: string }
// type OrderPayload = { placeId: string, newOrder: Order }
// type AvailabilityPayload = { placeId: string, categoryId: string, available: boolean }
...
//     getCategory: thunk(async (actions, { placeId, categoryId }, helpers) => {
//         try {
...
//     getCategories: thunk(async (actions, placeId, helpers) => {
//         try {
...
//     createCategory: thunk(async (actions, { placeId, category }, helpers) => {
//         const { getStoreActions } = helpers
//         try {
...
//     updateCategory: thunk(async (actions, { placeId, categoryId, category }, helpers) => {
//         const { getStoreActions } = helpers
//         try {
...
//     deleteCategory: thunk(async (actions, { placeId, categoryId }, helpers) => {
//         const { getStoreActions } = helpers
//         try {
//             const { getState } = helpers
...
//     updateOrder: thunk(async (actions, { placeId, newOrder }, helpers) => {
//         const { getStoreActions } = helpers
//         try {
//             await firebase.firestore()
//                 .collection('places').doc(placeId)
...
//     updateAvailability: thunk(async (actions, { placeId, categoryId, available }, helpers) => {
//         const { getStoreActions } = helpers
//         try {
//             await firebase.firestore()
//                 .collection('places').doc(placeId)
